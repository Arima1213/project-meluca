...
<body class="bg-body" data-bs-spy="scroll" data-bs-target="#navbar" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" tabindex="0">
	...
	<div class="search-box position-relative w-100 overflow-hidden">
		<div class="search-wrap">
			...
			<form id="search-form" class="pt-3 text-center" action="" method="">
				<input type="text" class="search-input fs-5 bg-transparent p-4" placeholder="Search..." />
	...
	<footer id="footer" class="padding-large overflow-hidden">
	...
	<script src="https://cdn.jsdelivr.net/npm/promise-polyfill@8"></script>
